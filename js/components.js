  ...
  <div class="flex justify-between items-center h-20">
    ...
    <nav class="hidden md:flex space-x-8 text-sm font-medium items-center">
      ...
      <div class="relative group">
        ...
        <div class="absolute left-0 mt-2 w-64 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
          <div class="py-1" role="menu" aria-orientation="vertical">
            ...
            <a href="/black-widow-removal" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-orange">Black Widow Removal</a>
          </div>
        </div>
      </div>
  ...
  <div class="px-3 pt-2 pb-4 space-y-1">
    ...
    <div class="space-y-1">
      ...
      <div class="pl-6 space-y-1">
        ...
        <a href="/black-widow-removal" class="block px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-orange transition-colors">Black Widow Removal</a>
      </div>
    </div>
